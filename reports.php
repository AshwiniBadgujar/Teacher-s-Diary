...
<div class="side_nav">
    ...
    <a href="duties.php"><div class="side_option">
     ...
     <a href="reports.php"><div class="side_option2">
    	<div class="side_opimg"   style="background:#00eda6; width:5px; padding-left:0px;">
        	<img src="images/ico/reportico.png" class="s_opimg"  style="margin-left:20px;">
        </div>
        <div class="side_opname"   style="font-size:18px; margin-left:53px;">Reports</div>
    </div></a>
